...
%  2. audiogram = 2x3 array of HL at the following frequencies: 500,
%                   1000, 2000      ex. [10,20,30;10,20,30]
...
noiseSNR_5=noise65db*(db2amp(SPL30-70));
noiseSNR0=noise65db*(db2amp(SPL30-65));
noiseSNR5=noise65db*(db2amp(SPL30-60));
noiseSNR10=noise65db*(db2amp(SPL30-55));
noiseSNR15=noise65db*(db2amp(SPL30-50));

% 6. Output sound files
audiowrite(strcat(subid,'stim.wav'),stim65db,10000)
audiowrite(strcat(subid,'noiseSNR_5.wav'),noiseSNR_5,44100)
audiowrite(strcat(subid,'noiseSNR0.wav'),noiseSNR0,44100)
audiowrite(strcat(subid,'noiseSNR5.wav'),noiseSNR5,44100)
audiowrite(strcat(subid,'noiseSNR10.wav'),noiseSNR10,44100)
audiowrite(strcat(subid,'noiseSNR15.wav'),noiseSNR15,44100)